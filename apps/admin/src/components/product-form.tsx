...
export function ProductForm() {
  ...
  return (
    <form className="admin-form product-create-form" onSubmit={handleSubmit}>
      ...
      <section className="wide-field product-form-section">
      ...
      {/* Section 03: Tag sản phẩm */}
      <div className="wide-field">
        <TagPicker selected={selectedTags} onChange={setSelectedTags} />
      </div>

      {/* Section 04: Hình ảnh sản phẩm */}
      <section className="wide-field product-form-section">
        <div className="product-form-section-heading">
          <span>03</span>
          <div>
            <strong>Hình ảnh sản phẩm</strong>
            <small>Kéo thả để sắp xếp thứ tự hiển thị. Ảnh đầu tiên sẽ là ảnh đại diện.</small>
          </div>
        </div>
